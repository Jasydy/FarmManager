...
class ImageManager {
    static async enumImages({activeImagesPath, draftImagesPath, minImageNum = 4}) {
        ...
        for(let i = 0; i < draftImages.length; i++) {
            ...
            await FsManager.rename({
                ...
                destPath: path.resolve(activeImagesPath, (lastImageNum + i) + ext),
            });
        }
